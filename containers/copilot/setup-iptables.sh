...
echo "[iptables] Setting up egress traffic redirection to Squid proxy..."
...
# Allow traffic within Docker network (for container-to-container communication)
...
echo "[iptables] iptables rules applied successfully"
